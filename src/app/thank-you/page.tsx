          ...
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                Your order was processed and your assests are available to
              ...
              <p>
                ...
                it. Hang tight and we&apos;ll send you confirmation very soon!
              </p>
            )}
            <div className="mt-16 text-sm font-medium">
                  ...
                  return (
                    <li key={product.id} className="flex space-x-6 py-6">
                      ...
                      <div className="flex-auto flex flex-col justify-between">
                        ...
                        <p className="flex-none font-medium tet-gray-900">
              ...
              <div className="space-y-6 border-t border-gray-200 text-sm pt-6 font-medium ">
                ...
                <div className="flex items-center justify-between border-t border-gray-900">
