...
const Page = ()=>{
    ...
    const {mutate,isLoading} = trpc.auth.createPayloadUser.useMutation({
        ...
        onSuccess:({sentToEmail})=>{
            toast.success(`We have sent the verificatione email to ${sentToEmail}`)
    ...
    return(
        <>
            <div className="container relative flex pt-20 flex-col items-center justify-center lg:px-0">
                <div className="mx-auto flex w-full flex-col jusitfy-center space-y-6 sm:w-[350px] ">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="grid gap-2">
                                <div className="grid gap-1 py-2">
                                    ...
                                    {errors.email && ( <p className="text-sm tex-red-500">{errors.email.message}</p>)}
                                </div>
                                <div className="grid gap-1 py-2">
                                    ...
                                    {errors?.password && ( <p className="text-sm tex-red-500">{errors.password.message}</p>)}
                                </div>
